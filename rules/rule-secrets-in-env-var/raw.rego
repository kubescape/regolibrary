...
deny[msga] {
	...
	path := sprintf("spec.initContainers[%v].env[%v].name", [format_int(i, 10), format_int(j, 10)])
...
deny[msga] {
	...
	path := sprintf("spec.template.spec.initContainers[%v].env[%v].name", [format_int(i, 10), format_int(j, 10)])
...
deny[msga] {
	...
	path := sprintf("spec.jobTemplate.spec.template.spec.initContainers[%v].env[%v].name", [format_int(i, 10), format_int(j, 10)])
