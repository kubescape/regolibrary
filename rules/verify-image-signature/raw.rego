...
deny contains msga if {
	...
	path := sprintf("spec.initContainers[%v].image", [i])
...
deny contains msga if {
	...
	path := sprintf("spec.ephemeralContainers[%v].image", [i])
...
deny contains msga if {
	...
	path := sprintf("spec.template.spec.initContainers[%v].image", [i])
...
deny contains msga if {
	...
	path := sprintf("spec.jobTemplate.spec.template.spec.initContainers[%v].image", [i])
